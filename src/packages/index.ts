...
import { CompList } from '@/packages/components/Comps/index'
...
import { ImageList } from '@/packages/components/Images/index'
import { VideoList } from '@/packages/components/Videos/index'
...
export let packagesList: PackagesType = {
  ...
  [PackagesCategoryEnum.COMPS]: CompList,
  [PackagesCategoryEnum.PHOTOS]: PhotoList,
  [PackagesCategoryEnum.ICONS]: IconList,
  [PackagesCategoryEnum.IMAGES]: ImageList,
  [PackagesCategoryEnum.VIDEOS]: VideoList
}
